...
const CardModal = ({ setBoardModal, noteDone, setNoteDone, card }) => {
  ...
  return (
    <section
      className="fixed z-10 top-0 right-0 left-0 bottom-0 bg-black/30 grid place-items-center"
        ...
        <div className="flex items-center justify-between border-b border-gray-300 p-2">
          <div className="flex items-center pl-4 text-gray-400 text-sm">
            ...
            <div className="flex items-center space-x-2 px-3 pl-4">
              <span>Progress:</span>
              <div className="p-2 bg-teal-500 rounded-lg cursor-pointer text-white rounded-tl-3xl rounded-bl-3xl">
                0%
              </div>
              <div className="p-2 bg-gray-200 rounded-lg cursor-pointer hover:text-white hover:bg-teal-500 duration-200 ">
                25%
              </div>
              <div className="p-2 bg-gray-200 rounded-lg cursor-pointer hover:text-white hover:bg-teal-500 duration-200 ">
                50%
              ...
              <div className="p-2 bg-gray-200 rounded-lg cursor-pointer hover:text-white hover:bg-teal-500 duration-200 rounded-tr-3xl rounded-br-3xl">
                100%
              </div>
            </div>
          ...
          <div className="flex items-center p-3 relative">
            <Dropdown
              button={
                <DotsSingle
                  className="text-[#7088A1] cursor-pointer w-8 h-8 translate-x-[-8px] p-1 py-2 rounded-md hover:bg-gray-200 hover:text-teal-500 duration-200"
                //   onClick={(e) => {
                //     e.stopPropagation();
