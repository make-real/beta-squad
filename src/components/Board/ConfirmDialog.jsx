...
const ConfirmDialog = ({
  ...
  const handleDelete = async (e) => {
    ...
    try {
      if (listID &&selectedSpaceId &&cardID===undefined) {
        ...
        navigate(`/projects/${selectedWorkspaceId}/squad/${selectedSpaceId}`, {
          state: {
            tab: "board",
          },
        });
     ...
     else if (spaceFiledID && spaceFiledID) {
        const { data } = await delete_file_link(spaceID, spaceFiledID);
