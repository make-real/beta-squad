...
>>>>>>> b83c5b86ffe8a46b50f3fe9524e247b542ee6469
  ...
  return (
    <>
      <div
        className={`${
          showFullBar ? "min-w-[225px] w-[225px]" : "w-max items-center"
        } bg-[#2C3782] pt-[20px] flex flex-col`}>
        <div
          className={`flex items-center justify-between ${
            showFullBar ? "pl-[25px] pr-[10px]" : "pl-[25px] pr-[25px]"
          }`}>
          {showFullBar && (
          ...
          <div className='w-max' onClick={() => setShowFullBar(!showFullBar)}>
            ...
            return (
              <div
                className={`flex items-center gap-3 cursor-pointer py-[10px] ${
                  selectedWorkspace === workSpace?._id ? "bg-[#6576FF10]" : ""
                } ${showFullBar ? "pl-[25px]" : "pl-[25px] pr-[25px]"}`}
                onClick={() => {
            ...
            {allSpaces.map((space) => {
              return (
                <div
                  ...
                  />
                  {showFullBar && (
                    <p className='text-[14px] text-[#C4CEFE]'>{space.name}</p>
                  )}
                </div>
              );
            })}
        ...
        <p
          ...
          &copy;
          {showFullBar && <span className='ml-[10px]'>Taskmanager 2022</span>}
        </p>
      </div>
