        ...
        {msg?.sender?.avatar ? (
          ...
          <h6 className='text-xs absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 text-white'>
            ...
            <div
                ...
                className={`relative ${
                    msg?.sender?._id === userId ? "bg-slate-100 " : "bg-[#F5F5F5] text-[#7C04EC] mr-3"
            ...
            >
                ...
                >
                    ...
                    <small
                        className={`flex flex-row-reverse gap-2 ${
                            msg?.sender?._id === userId ? "text-[#ACB0B6] font-[400] mr-auto" : "ml-auto text-[#ACB0B6] font-[400] w-24"
                        }`}
                    >
                ...
                {msg?.sendingFailed && <h1 className="text-red-500">Sending Failed!</h1>}
