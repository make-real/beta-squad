...
const SingleChat = () => {
  ...
  return (
    <div className={`${margin ? "ml-[325px]" : "ml-[50px]"}`}>
      ...
      >
        <TextMessage messageToRespond={messageToRespond} setMessageToRespond={setMessageToRespond} />
      </div>
      <MessageBox messageToRespond={messageToRespond} setMessageToRespond={setMessageToRespond} />
    </div>
  );
};
