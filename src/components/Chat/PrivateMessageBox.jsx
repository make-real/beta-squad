...
const PrivateMessageBox = ({ messageToRespond, setMessageToRespond, custom, onComment }) => {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            if (custom) {
                ...
                await send_single_message(workspace_id, participantID, {
                    ...
                    <div className={`w-full ${messageToRespond && "border-[0.5px] border-white p-3 rounded-md"}`}>
                        {messageToRespond && (
                            <div className="flex mb-2 justify-between border-l-4 border-blue-500 bg-blue-200 text-neutral-500 p-3 rounded-md">
                                <div>
                                    <p className="text-bold text-blue-500 text-sm mb-1">{messageToRespond?.sender?.fullName}</p>
                            ...
                            <div className="w-full flex relative z-[9999] shadow-md border bg-white rounded-lg px-3 py-2">
                                <MentionsInput
                                    ...
                                    customSuggestionsContainer={(children) => (
                                        <div className="bg-white absolute bottom-6 min-w-[300px] shadow-sm">{children}</div>
                                    )}
                                ...
                                <div className="text-gray-400 flex mt-[5px]">
                                    ...
                                    <div className="px-2 cursor-pointer relative">
                                        <GoMention className="duration-300  hover:text-blue-500" onClick={handleMention} />
                                    </div>
