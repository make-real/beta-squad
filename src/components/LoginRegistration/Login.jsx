...
const Login = () => {
        ...
        try {
            ...
            if (data?.loggedUser?.emailVerified) {
                ...
                localStorage.setItem(
                    'userId',
                    JSON.stringify(data.loggedUser._id)
                );
    ...
    const handleForgotPassword = async (e) => {
        ...
        try {
            ...
            sessionStorage.setItem(
                'userEmail',
                JSON.stringify(userInput.email)
            );
    ...
    return (
        <section className="flex justify-between items-center gap-10 w-[70%] mx-auto">
            {/* left side */}
                ...
                <div className="mt-20">
                    ...
                    >
                        {gloader ? (
                            ...
                            <>
                                <img src={images.googleIcon} alt="" /> Sign in
                                with google
                            </>
                        )}
                    </button>
