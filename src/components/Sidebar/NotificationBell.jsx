...
const NotificationBell = ({ userNotificationBell }) => {
    ...
    return (
        <section className={`w-[465px] h-[495px] bg-white shadow-2xl ${margin && userNotificationBell ? 'fixed' : 'hidden'} top-[50px] left-[135px] p-3 rounded-md before:content-[""] before:w-5 before:h-5 before:absolute before:top-[-8px] before:left-4 before:rotate-45 before:-  before:bg-white`}>
