...
const NotificationBell = ({ userNotificationBell }) => {
    ...
    return (
        <section className={`w-[465px] h-[495px] bg-white shadow-2xl ${margin && userNotificationBell ? 'fixed' : 'hidden'} top-[60px] left-[95px] p-3 z-50   before:content-[""] before:w-8 before:h-8 before:absolute before:top-[-10px] before:left-2 before:rotate-45 before:-z-10 before:bg-white`}>
