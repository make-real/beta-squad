                        ...
                        <div className='relative px-3 py-2 flex gap-3 items-center justify-between h-12 mt-2 w-3/4'>
                            {
                                boxHexColorCodes.map(hexColorCode => (
                                    <div
                                        ...
                                        className={`${clickColorBox === hexColorCode ? 'w-12 h-12' : 'w-7 h-7'} transition duration-200 rounded-full cursor-pointer`}
                                        ...
                                        onClick={() => {
                                            ...
                                            setCreateNewSpace(pre => ({ ...pre, color: hexColorCode })) // pass text color for object creating key:value  
                                        }}
                                    >
